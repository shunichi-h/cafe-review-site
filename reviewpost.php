...
if (isset($_POST["reviewpost"])) {
    ...
    if (!empty($_POST["reviewtitle"]) && !empty($_POST["reviewtext"])) {
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="reviewpost-stylesheet.css?1234">
...
<body>
  ...
  <div class="reviewpostform-wrapper">
    <div class="container">
      ...
      <p class="shopname text">レビューを投稿するお店：<?php echo $key['shop_name'] ?></p>
      ...
      <form id="reviewpostForm" name="reviewpostForm" action="" method="POST" enctype="multipart/form-data">
        <fieldset style="border: none;">
          ...
          <label class="reviewuser" for="reviewuser">レビューを投稿するユーザー：<?php echo $_SESSION["NAME"];?>さん</label><br>
          ...
          <input class="reviewpostform titleform" type="text" id="reviewtitle" name="reviewtitle" value="" placeholder="レビューのタイトルを入力">
          ...
          <textarea class="reviewpostform titleform" id="reviewtext"　cols="30" rows="10" name="reviewtext" placeholder="レビューの本文を入力"></textarea>
  ...
  <script src="reviewpostscript.js?1234">
  </script>
